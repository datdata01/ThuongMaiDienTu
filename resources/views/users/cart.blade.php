        ...
        <div class="row w-100 gy-10 mb-md-20">
            <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            @foreach($cart->cartDetails as $key => $cartDetail)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                        <img src="{{ asset($cartDetail->product->images[0]->image_url) }}" 
                                    ...
                                    <td>
                                        ...
                                        <input type="number" value="{{ $cartDetail->quantity }}" name="quantity[]" class="form-control">
                                    </td>
                                    <td>
                                        @php
                ...
                @else
                    <tbody>
                        <tr>
                            <td colspan="8">Bạn chưa có sản phẩm trong giỏ hàng</td>
                        </tr>
                        <tr>
                            <td colspan="8">
